                ...
                <div class="card-body">
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input v-bind:class="{'is-invalid': errors.PIC}" type="text" v-model="PIC" class="form-control" placeholder="Full name of the user.">
                            <div class="invalid-feedback" v-if="errors.PIC">
                                <p>{{ errors.PIC[0] }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Related Service</label>
                        <div class="col-sm-12 col-md-7">
                            <input v-bind:class="{'is-invalid': errors.related_service}" type="text" v-model="related_service" class="form-control" placeholder="Email address (should be unique).">
                            <div class="invalid-feedback" v-if="errors.related_service">
                                <p>{{ errors.related_service[0] }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                    <div class="form-group row mb-4">
                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">issue</label>
                        <div class="col-sm-12 col-md-7">
                            <input v-bind:class="{'is-invalid': errors.issue}" type="text" v-model="issue" class="form-control" placeholder="Full name of the user.">
                            <div class="invalid-feedback" v-if="errors.issue">
                                <p>{{ errors.issue[0] }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">PIC</label>
                        <div class="col-sm-12 col-md-7">
                            <input v-bind:class="{'is-invalid': errors.date}" type="text" v-model="date" class="form-control" placeholder="Full name of the user.">
    ...
    export default {
        ...
        methods: {
            ...
            addUser() {
                ...
                _this.message = '';
                _this.loading = true;
                axios.post(this.$parent.MakeUrl('admin/users'), {'PIC': this.PIC, 'related_service': this.related_service, 'issue': this.issue, 'date': this.date}).then((res) => {
                    _this.loading = false;
                    _this.resetForm();
